/**
 * @file conf.c  Configuration reader/writer
 *
...
{"baudrate", CONF_INT, FCONF_VIDX(baudrate),           NULL,    9600},
{"stopbits", CONF_INT, FCONF_VIDX(stopbits),           NULL,    1},
{"slaveid",  CONF_INT, FCONF_VIDX(slaveid),            NULL,    1},
